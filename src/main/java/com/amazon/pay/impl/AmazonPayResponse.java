...
public class AmazonPayResponse {
    ...
    public AmazonPayResponse(AmazonPayResponse amazonPayResponse) {
        this.rawResponse = amazonPayResponse.rawResponse;
        this.status = amazonPayResponse.status;
    }
    /**
    ...
    public String toXML() {
        return XML.toString(this.response);
    }
