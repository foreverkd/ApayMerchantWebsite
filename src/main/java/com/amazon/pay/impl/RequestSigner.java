...
public class RequestSigner {
    ...
    public RequestSigner(final PayConfiguration payConfiguration) throws AmazonClientException {
    ...
    private String buildAuthorizationHeader(String publicKeyId,
                                            ...
                                            String signature) throws AmazonClientException {
        ...
        if (publicKeyId == null || preSignedHeaders == null || signature == null) {
            throw new AmazonClientException("Invalid parameter while constructing authorization header");
        }
