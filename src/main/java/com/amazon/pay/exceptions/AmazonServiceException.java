 ...
 * by Amazon Pay API. Receiving an exception of this type indicates that
...
public class AmazonServiceException extends Exception implements Serializable {
     ...
     * @param response
     *                  Specify raw response received from Amazon Pay API
     */
    ...
    public AmazonServiceException(ErrorResponse errorResponse, AmazonPayResponse amazonPayResponse) {
        super(amazonPayResponse.getRawResponse());

        this.rawResponse = amazonPayResponse.getRawResponse();
        this.statusCode = amazonPayResponse.getStatus();
