...
public class OrderReferenceDetails {
    ...
    public OrderReferenceDetails(String amazonOrderReferenceId) {
        this.amazonOrderReferenceId = amazonOrderReferenceId;
    }

    public OrderReferenceDetails(String amazonOrderReferenceId, Buyer buyer, OrderTotal orderTotal, String sellerNote, String platformId, Destination destination, PaymentDescriptor paymentDescriptor, BillingAddress billingAddress, Environment releaseEnvironment, SellerOrderAttributes sellerOrderAttributes, OrderReferenceStatus orderReferenceStatus, Constraints constraints, XMLGregorianCalendar creationTimestamp, XMLGregorianCalendar expirationTimestamp, ParentDetails parentDetails, IdList idList, String orderLanguage, Boolean requestPaymentAuthorization, PaymentServiceProviderAttributes paymentServiceProviderAttributes, PaymentReference paymentReference, PaymentAuthenticationStatus paymentAuthenticationStatus) {
        this.amazonOrderReferenceId = amazonOrderReferenceId;
        this.buyer = buyer;
        ...
        this.paymentServiceProviderAttributes = paymentServiceProviderAttributes;
        this.paymentReference = paymentReference;
        this.paymentAuthenticationStatus = paymentAuthenticationStatus;
    }
    ...
    public void setReleaseEnvironment(Environment releaseEnvironment) {
        this.releaseEnvironment = releaseEnvironment;
    }

    public void setSellerOrderAttributes(SellerOrderAttributes sellerOrderAttributes) {
        this.sellerOrderAttributes = sellerOrderAttributes;
    }

    public void setOrderReferenceStatus(OrderReferenceStatus orderReferenceStatus) {
        this.orderReferenceStatus = orderReferenceStatus;
    }
    ...
    public void setExpirationTimestamp(XMLGregorianCalendar expirationTimestamp) {
        this.expirationTimestamp = expirationTimestamp;
    }
    ...
    public void setRequestPaymentAuthorization(Boolean requestPaymentAuthorization) {
        this.requestPaymentAuthorization = requestPaymentAuthorization;
    }

    public void setPaymentServiceProviderAttributes(PaymentServiceProviderAttributes paymentServiceProviderAttributes) {
        this.paymentServiceProviderAttributes = paymentServiceProviderAttributes;
    }
    ...
    public void setPaymentAuthenticationStatus(PaymentAuthenticationStatus paymentAuthenticationStatus) {
        this.paymentAuthenticationStatus = paymentAuthenticationStatus;
    }
}
